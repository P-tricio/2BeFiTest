...
const LoginScreen = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-slate-50 animate-in fade-in">
            <div className="w-full max-w-sm bg-white p-8 rounded-[32px] shadow-lg border border-slate-100">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-black text-slate-900 mb-2">
                        {isLogin ? '¡Hola de nuevo!' : 'Crea tu cuenta'}
                    </h1>
                    <p className="text-slate-500 font-medium">
                        {isLogin ? 'Accede a tu historial y progresos' : 'Empieza tu viaje fitness hoy'}
                    </p>
                </div>
                ...
                <form onSubmit={handleAuth} className="space-y-4">
                    {!isLogin && (
                        <div>
                            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest pl-4 mb-1 block">Nombre</label>
                            <input
                                type="text"
                                value={name}
                    ...
                    <div>
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-widest pl-4 mb-1 block">Email</label>
                        <input
                            type="email"
                            value={email}
                    ...
                    <div>
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-widest pl-4 mb-1 block">Contraseña</label>
                        <input
                            type="password"
                            value={password}
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full py-4 rounded-2xl border-2 border-slate-200 text-slate-700 font-bold flex items-center justify-center gap-2 hover:bg-slate-50 transition-colors"
                >
