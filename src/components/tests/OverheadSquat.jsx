...
const OverheadSquat = () => {
    ...
    return (
        <div className="flex flex-col h-full p-6 space-y-6 overflow-y-auto bg-slate-50 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <h2 className="text-2xl font-black text-slate-900 text-center">Sentadilla Overhead</h2>
            ...
            <div className="bg-white rounded-[32px] p-6 flex flex-col items-center shadow-sm border border-slate-100">
                <div className="w-full relative aspect-square bg-slate-50 rounded-2xl mb-6 overflow-hidden border border-slate-100">
                    ...
                    />
                    <div className="absolute top-2 right-2 bg-teal-100 text-teal-600 p-2 rounded-full">
                        <Maximize2 size={20} />
                    </div>
                </div>
            ...
            <div className="bg-blue-50 p-5 rounded-2xl text-sm font-medium text-blue-800 border border-blue-100 mb-2">
            ...
            <div className="pt-6 pb-8 w-full mt-auto">
                <button
                    onClick={handleSave}
                    className="btn-primary w-full py-4 text-lg shadow-xl shadow-blue-500/20"
                >
...
const CheckItem = ({ label, checked, onClick }) => (
    ...
    >
        <div className={clsx(
            ...
            checked ? "bg-blue-100 text-blue-600" : "bg-slate-50 text-slate-300 group-hover:bg-blue-50 group-hover:text-blue-400"
        )}>
